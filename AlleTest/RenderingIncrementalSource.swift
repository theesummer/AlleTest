//
//  RenderingIncrementalSource.swift
//  AlleTest
//
...
public class RenderingIncrementalSource: RenderingSource {
    private let data : Data
    private let increment: Int
    private let updateInterval : TimeInterval
    private let dispatchQueue: DispatchQueue

    private var callback : ((RenderingIncrementalSource) -> Void)?
    ...
    func load(_ callback: @escaping (RenderingIncrementalSource) -> Void) {
